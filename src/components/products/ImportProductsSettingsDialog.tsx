...
type ImportSettingsFormData = z.infer<ReturnType<typeof importSettingsSchema>>;

interface ImportProductsSettingsDialogProps {
  open: boolean;
...
export default function ImportProductsSettingsDialog({
  open,
  onOpenChange,
  fileName,
  itemCount,
  onConfirmImport,
  isImporting,
}: ImportProductsSettingsDialogProps) {
