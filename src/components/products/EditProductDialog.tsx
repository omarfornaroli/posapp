  ...
  useEffect(() => {
    if (product && open && !isLoadingTranslations) {
      form.reset({
        ...
        markup: product.markup !== undefined ? String(product.markup) : '',
        price: product.price?.toString() ?? '', 
        tax: product.tax !== undefined ? String(product.tax * 100) : '', 
        ...
        preferredQuantity: product.preferredQuantity !== undefined ? String(product.preferredQuantity) : '',
        lowStockWarning: product.lowStockWarning || false,
        warningQuantity: product.warningQuantity !== undefined ? String(product.warningQuantity) : '',
