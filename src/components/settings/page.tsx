...
import TranslateSettingsForm from '@/components/settings/TranslateSettingsForm';
import { useAuth } from '@/context/AuthContext';
import AccessDeniedMessage from '@/components/AccessDeniedMessage';
import { Cog, ReceiptText, Mail, BrainCircuit, ShoppingCart, Languages } from 'lucide-react';
    ...
    <div className="space-y-6">
        ...
        <Tabs defaultValue="receipt" className="w-full">
            <TabsList className="grid w-full grid-cols-2 md:grid-cols-5">
                ...
                <TabsTrigger value="translation"><Languages className="mr-2"/>{t('TranslateSettingsForm.title')}</TabsTrigger>
            </TabsList>
