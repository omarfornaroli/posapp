...
import { PlusCircle, Languages, Loader2 } from 'lucide-react';
...
export default function LanguagesManagerPage() {
  ...
  const { appLanguages, isLoading: isLoadingData, addLanguage, updateLanguage, deleteLanguage } = useDexieAppLanguages();
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="shadow-xl">
        <CardHeader>
          <CardTitle>{t('LanguagesManagerPage.listTitle')}</CardTitle>
          <CardDescription>{t('LanguagesManagerPage.listDescription')}</CardDescription>
        </CardHeader>
